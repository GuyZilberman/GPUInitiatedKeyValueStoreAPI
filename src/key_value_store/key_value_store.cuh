...
private:
    ...
    __device__
    bool getTailAndCheckFull(ThreadBlockResources* d_tbResources, int &tid, int &incrementSize);
...
class KeyValueStore {
    private:
        ...
        void process_async_get(KVMemHandle &kvMemHandle, int blockIndex, ResponseMessage &res_msg, int currModTail, size_t num_keys);
